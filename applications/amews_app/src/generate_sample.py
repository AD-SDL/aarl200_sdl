from big_kahuna_protocol_types import BigKahunaProtocol, BigKahunaDispense, BigKahunaPlate, BigKahunaChemical, BigKahunaParameter, BigKahunaStir, BigKahunaTransfer, BigKahunaDelay
import string
def generate_sample_protocol(start_well_index):
    ...
    while target_well_index + len(input_wells) < len(tube_rack_wells):
        for well in input_wells:
            ...
            target_well_index += 1
        protocol.actions.append(BigKahunaDelay(target_plate="cell_plate_1", delay=5))
